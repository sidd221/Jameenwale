...
const HINGE_CONFIG: Record<HingeType, { origin: string; rotateX: number; rotateY: number }> = {
...
export const FoldText: React.FC<FoldTextProps> = ({
  ...
  const rootStyle: React.CSSProperties = {
    ...(fontSize ? { ['--fold-text-font-size' as any]: typeof fontSize === 'number' ? `${fontSize}px` : fontSize } : {}),
